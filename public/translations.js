const translations = {
    ko: {
        ...
        "footer-desc-us": "데이터 제공: CNN Business 및 FRED(세인트루이스 연준).",
        ...
        "settings": "설정",
        "withdraw": "탈퇴하기",
        "withdraw-desc": "회원 탈퇴 시 모든 데이터가 삭제되며 복구할 수 없습니다.",
        "withdraw-confirm": "정말 탈퇴하시겠습니까? 이 작업은 되돌릴 수 없습니다.",
        "withdraw-success": "탈퇴 처리가 완료되었습니다.",
        "withdraw-failed": "탈퇴 처리에 실패했습니다.",
        "subscribe": "리포트 알림",
        "report-language": "리포트 언어 설정",
        "report-lang-desc": "이메일 리포트를 수신할 언어를 선택해주세요.",
        "instant-report": "즉시 리포트 발송",
        "instant-report-desc": "현재 시장 분석 리포트를 이메일로 발송합니다.",
        "send-now": "리포트 보내기",
        "email": "이메일",
        "name": "이름",
        "account-info": "계정 정보",
        "subscription-benefit": "가입 시 시장 지표 및 인공지능 분석 리포트를 이메일로 받아보실 수 있습니다.",
        ...
        "about-value-3-t": "개인화된 리포트 알림",
        "about-value-3-d": "매일 시장의 핵심 지표와 AI의 인사이트를 정리하여 회원님의 메일함으로 직접 배달합니다.",

        // Terms of Service Page
        "terms-title": "이용약관",
        "terms-section-1-t": "제 1 조 (목적)",
        "terms-section-1-d": "본 약관은 'anse.ai.kr'(이하 '서비스')가 제공하는 금융 정보 및 시장 분석 리포트 알림 서비스의 이용 조건 및 절차에 관한 사항을 규정함을 목적으로 합니다.",
        "terms-section-2-t": "제 2 조 (회원 서비스: 리포트 알림)",
        "terms-section-2-d": "가입 회원에게는 다음과 같은 서비스가 제공될 수 있습니다.",
        "terms-section-2-li1": "이메일 리포트 발송 (KOSPI 및 US 시장 지표 요약)",
        "terms-section-2-li2": "인공지능(AI) 기반 시장 상황 분석 및 제언 요약",
        "terms-section-2-li3": "기타 가입자 전용 데이터 및 기능",
        "disclaimer-desc": "본 정보는 참고용이며 투자 권유를 목적으로 하지 않습니다. AI 분석의 특성상 실시간 데이터 반영이 지연되거나 기술적 오류가 발생할 수 있으므로, 제공되는 수치의 정확성을 보장하지 않습니다. 실제 시장 지표와 다를 수 있으니 유의하시기 바랍니다.",
        ...
        // Refund Policy Page
        "refund-title": "서비스 정책",
        "refund-section-1-t": "서비스 이용 안내",
        "refund-section-1-d": "'anse.ai.kr'의 모든 시장 지표 분석 및 리포트 서비스는 현재 무료로 제공됩니다. 별도의 유료 구독이나 결제 시스템이 존재하지 않습니다.",
        "refund-section-2-t": "서비스 해지 안내",
        "refund-li1": "알림 중단: 'My Account' 페이지의 설정 메뉴를 통해 언제든지 이메일 리포트 수신을 중단할 수 있습니다.",
        "refund-li2": "회원 탈퇴: 계정 삭제 시 모든 개인정보와 알림 설정 데이터는 즉시 파기됩니다.",
        "refund-li3": "데이터 보존: 탈퇴 후에는 동일한 이메일로 재가입하더라도 이전의 설정이나 기록은 복구되지 않습니다.",
        "refund-section-3-t": "문의 방법",
        "refund-section-3-d": "서비스 이용 및 해지 관련 문의는 고객센터(info@anse.ai.kr)로 문의해 주시면 신속히 처리해 드립니다.",

        // Privacy Policy Page
        "privacy-intro": "본 웹사이트 (\"anse.ai.kr\")는 사용자 여러분의 개인정보를 중요하게 생각하며, 「개인정보 보호법」 및 관련 법령을 준수하고 있습니다.",
        "privacy-section-1-t": "1. 수집하는 개인정보 항목",
        "privacy-section-1-d": "본 웹사이트는 구글 로그인을 통해 사용자의 이름, 이메일 주소, 프로필 이미지를 수집합니다. 이는 사용자 식별 및 리포트 알림 발송 서비스를 위함입니다.",
    ...
    en: {
        ...
        "footer-desc-us": "Data provided by CNN Business and FRED (St. Louis Fed).",
        ...
        "settings": "Settings",
        "withdraw": "Withdraw",
        "withdraw-desc": "Deleting your account will remove all your data and cannot be undone.",
        "withdraw-confirm": "Are you sure you want to delete your account? This action cannot be undone.",
        "withdraw-success": "Your account has been successfully deleted.",
        "withdraw-failed": "Failed to delete your account.",
        "subscribe": "Market Reports",
        "report-language": "Report Language",
        "report-lang-desc": "Select the language for your email reports.",
        "instant-report": "Instant Report",
        "instant-report-desc": "Send the current market analysis report to your email.",
        "send-now": "Send Report",
        "email": "Email",
        "name": "Name",
        "account-info": "Account Info",
        "subscription-benefit": "Join us to receive market indicators and AI analysis reports via email.",
        ...
        "about-value-3-t": "Personalized Reports",
        "about-value-3-d": "We summarize key market indicators and AI insights, delivering them directly to your inbox every day.",

        // Terms of Service Page
        "terms-title": "Terms of Service",
        "terms-section-1-t": "Article 1 (Purpose)",
        "terms-section-1-d": "The purpose of these terms is to regulate the conditions and procedures for using the financial information and market analysis report notification service provided by 'anse.ai.kr' (hereinafter 'Service').",
        "terms-section-2-t": "Article 2 (Member Service: Report Notifications)",
        "terms-section-2-d": "Registered members may be provided with the following services:",
        "terms-section-2-li1": "Email report delivery (summary of KOSPI and US market indicators)",
        "terms-section-2-li2": "AI-based market condition analysis and advice summary",
        "terms-section-2-li3": "Other member-exclusive data and features",
        ...
        // Refund Policy Page
        "refund-title": "Service Policy",
        "refund-section-1-t": "Service Usage Info",
        "refund-section-1-d": "All market indicator analysis and report services on 'anse.ai.kr' are currently provided for free. There is no separate paid subscription or payment system.",
        "refund-section-2-t": "Cancellation Guide",
        "refund-li1": "Stopping Notifications: You can stop receiving email reports at any time via the settings menu on the 'My Account' page.",
        "refund-li2": "Account Deletion: Upon deleting your account, all personal information and notification settings data will be immediately destroyed.",
        "refund-li3": "Data Retention: After withdrawal, previous settings or records will not be restored even if you sign up again with the same email.",
        "refund-section-3-t": "How to Inquire",
        "refund-section-3-d": "For inquiries regarding service use and cancellation, please contact the customer center (info@anse.ai.kr) for prompt processing.",
        ...
        "privacy-section-1-d": "This website collects user's name, email address, and profile image via Google Login for identification and email notification services.",
